 ...
 */
package cat.albirar.template.engine.thymeleaf.test.configuration;
...
import cat.albirar.template.engine.thymeleaf.spring.configuration.TemplateEngineThymeleafConfiguration;
...
public class DefaultThymeleafTestConfiguration {
