 ...
 */
package cat.albirar.template.engine.thymeleaf.test.service.exceptions;
...
import cat.albirar.template.engine.thymeleaf.test.service.AbstractThymeleafTest;
...
public class TemplateEngineExceptionsTest extends AbstractThymeleafTest {
    @Autowired
    ...
    public void when_templateIsOfUnkownLanguage_then_anIllegalStateExceptionIsThrown() {
        ...
        tInstance = TemplateInstanceBean.buildInstance(thymeleafVarHtmlTemplateDefinition.toBuilder()
                .templateEngineLanguage("RRRR")
                .build())
                .build()
                ;
    ...
    public void when_templateThereAreNotAuthorizationToReadThem_then_aTemplateNotAccessibleExceptionIsThrown() throws Exception {
        ...
        file = applicationContext.getResource(thymeleafVarHtmlTemplateDefinition.getTemplate()).getFile();
